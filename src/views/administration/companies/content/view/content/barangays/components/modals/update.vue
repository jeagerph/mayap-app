    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await this.update({
                url: `/administration/company/${this.$route.params.code}/barangay/${this.companyBarangay.id}`,
                form: this.form,
            });
        ...
        initialize()
        {
            this.form.province_id = this.companyBarangay.province_id;
            this.form.city_id = this.companyBarangay.city_id;
            this.form.barangay_id = this.companyBarangay.barangay_id;

            this.form.province_name = this.companyBarangay.province_name;
            this.form.city_name = this.companyBarangay.city_name;
            this.form.barangay_name = this.companyBarangay.barangay_name;
        },
