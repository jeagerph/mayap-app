...
export default
{
    ...
    {
        ...mapGetters({
            account: 'adminCompanyAccount/selected',
            modules: 'adminCompanyAccount/modules',
    ...
    {
        ...mapActions({
            loadPrerequisite: 'adminCompanyAccount/loadPrerequisite',
        }),

        async loadModules()
        {
            this.loadPrerequisite({
                url: `/administration/company/module/options`,
                action: 'modules'
            });
        },
