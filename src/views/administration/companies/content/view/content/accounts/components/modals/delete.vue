        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top">
                <p>
                    ...
                    <span class="ap-text-bold">{{account.full_name}}</span> account.
                </p>
...
export default
{
    ...
    {
        ...mapActions({
            destroy: 'adminCompanyAccount/destroy',
        }),
        ...
        async submit()
        {
            ...
            const response = await this.destroy({
                url: `/administration/company/${this.$route.params.code}/account/${this.companyAccount.slug.code}`,
                item: this.companyAccount,
            });
