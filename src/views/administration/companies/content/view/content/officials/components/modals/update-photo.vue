<template>
    <ap-modal
        ...
        <ap-modal-body>
            <ap-modal-title>
                Update {{official.name}} Photo
            </ap-modal-title>

            <hr class="ap-margin-small-top">

            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-photo-image">Select Photo</label>
                <input class="ap-display-none" id="upload-photo-image" type="file" accept="image/**" @change="onFileChange">
                <ap-input
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            const response = await this.update({
                url: `/administration/barangay/${this.$route.params.code}/official/${this.official.id}/photo`,
                form: formPhoto,
            });
