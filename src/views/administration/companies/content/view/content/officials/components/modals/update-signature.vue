<template>
    <ap-modal
        :isOpen.sync="$parent.$data.updateSignatureModal"
        :isCenter="true">
        <ap-modal-body>
            <ap-modal-title>
                Update {{official.name}} Signature
            </ap-modal-title>

            <hr class="ap-margin-small-top">

            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-signature-image">Select Photo</label>
                <input class="ap-display-none" id="upload-signature-image" type="file" accept="image/**" @change="onFileChange">
                <ap-input
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            const response = await this.update({
                url: `/administration/barangay/${this.$route.params.code}/official/${this.official.id}/signature`,
                form: formPhoto,
            });
        ...
        closeModal()
        {
            this.$parent.toggleModal('updateSignature', false);
        },
