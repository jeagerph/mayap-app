<template>
    <div class="ap-margin-top ap-form-stacked">
        <div class="accordion ap-margin-top" id="form-accordion-mediator">
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await Http.put(
                `/administration/barangay/${this.$route.params.code}/case/setting/mediator`,
                {
                    mediator: this.forms
                }
            );
        ...
        initialize()
        {
            this.forms = this.caseSetting.mediator_documents;
        },
