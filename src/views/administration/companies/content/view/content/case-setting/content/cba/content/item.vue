<template>
    <div class="accordion-item">
        ...
        <div :id="`collapse-form-primary-${form.keyword}`" class="accordion-collapse collapse" aria-labelledby="form-primary" data-bs-parent="#form-accordion-cba" style="">
            <div class="accordion-body">
                ...
                <ap-input
                    ...
                    v-model="form.name"
                    :error="hasError(`cba.${$vnode.key}.name`) ? errors[`cba.${$vnode.key}.name`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`cba.${$vnode.key}.header.title`) ? errors[`cba.${$vnode.key}.header.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`cba.${$vnode.key}.content.title`) ? errors[`cba.${$vnode.key}.content.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`cba.${$vnode.key}.content.subtitle`) ? errors[`cba.${$vnode.key}.content.subtitle`][0] : ''" />
                ...
                <ap-input
                    ...
                    v-model="form.path"
                    :error="hasError(`cba.${$vnode.key}.path`) ? errors[`cba.${$vnode.key}.path`][0] : ''"/>
                ...
                <ap-grid :gutter="'small'">
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`cba.${$vnode.key}.view.index`) ? errors[`cba.${$vnode.key}.view.index`][0] : ''"/>
                    </div>
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            type="text"
                            ...
                            :error="hasError(`cba.${$vnode.key}.view.header`) ? errors[`cba.${$vnode.key}.view.header`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`cba.${$vnode.key}.view.content`) ? errors[`cba.${$vnode.key}.view.content`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`cba.${$vnode.key}.view.footer`) ? errors[`cba.${$vnode.key}.view.footer`][0] : ''"/>
                    </div>
                </ap-grid>
