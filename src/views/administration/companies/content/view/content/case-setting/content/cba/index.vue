<template>
    <div class="ap-margin-top ap-form-stacked">
        <div class="accordion ap-margin-top" id="form-accordion-cba">
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await Http.put(
                `/administration/barangay/${this.$route.params.code}/case/setting/cba`,
                {
                    cba: this.forms
                }
            );
        ...
        initialize()
        {
            this.forms = this.caseSetting.cba_documents;
        },
