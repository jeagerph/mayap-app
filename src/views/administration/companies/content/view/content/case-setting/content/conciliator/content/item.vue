<template>
    <div class="accordion-item">
        ...
        <div :id="`collapse-form-primary-${form.keyword}`" class="accordion-collapse collapse" aria-labelledby="form-primary" data-bs-parent="#form-accordion-conciliator" style="">
            <div class="accordion-body">
                ...
                <ap-input
                    ...
                    v-model="form.name"
                    :error="hasError(`conciliator.${$vnode.key}.name`) ? errors[`conciliator.${$vnode.key}.name`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`conciliator.${$vnode.key}.header.title`) ? errors[`conciliator.${$vnode.key}.header.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`conciliator.${$vnode.key}.content.title`) ? errors[`conciliator.${$vnode.key}.content.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`conciliator.${$vnode.key}.content.subtitle`) ? errors[`conciliator.${$vnode.key}.content.subtitle`][0] : ''" />
                ...
                <ap-input
                    ...
                    v-model="form.path"
                    :error="hasError(`conciliator.${$vnode.key}.path`) ? errors[`conciliator.${$vnode.key}.path`][0] : ''"/>
                ...
                <ap-grid :gutter="'small'">
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`conciliator.${$vnode.key}.view.index`) ? errors[`conciliator.${$vnode.key}.view.index`][0] : ''"/>
                    </div>
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            type="text"
                            ...
                            :error="hasError(`conciliator.${$vnode.key}.view.header`) ? errors[`conciliator.${$vnode.key}.view.header`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`conciliator.${$vnode.key}.view.content`) ? errors[`conciliator.${$vnode.key}.view.content`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`conciliator.${$vnode.key}.view.footer`) ? errors[`conciliator.${$vnode.key}.view.footer`][0] : ''"/>
                    </div>
                </ap-grid>
