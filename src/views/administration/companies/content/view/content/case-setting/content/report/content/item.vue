<template>
    <div class="accordion-item">
        ...
        <div :id="`collapse-form-primary-${form.keyword}`" class="accordion-collapse collapse" aria-labelledby="form-primary" data-bs-parent="#form-accordion-report" style="">
            <div class="accordion-body">
                ...
                <ap-input
                    ...
                    v-model="form.name"
                    :error="hasError(`report.${$vnode.key}.name`) ? errors[`report.${$vnode.key}.name`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`report.${$vnode.key}.header.title`) ? errors[`report.${$vnode.key}.header.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`report.${$vnode.key}.content.title`) ? errors[`report.${$vnode.key}.content.title`][0] : ''" />
                ...
                <ap-input
                    ...
                    :error="hasError(`report.${$vnode.key}.content.subtitle`) ? errors[`report.${$vnode.key}.content.subtitle`][0] : ''" />
                ...
                <ap-input
                    ...
                    v-model="form.path"
                    :error="hasError(`report.${$vnode.key}.path`) ? errors[`report.${$vnode.key}.path`][0] : ''"/>
                ...
                <ap-grid :gutter="'small'">
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`report.${$vnode.key}.view.index`) ? errors[`report.${$vnode.key}.view.index`][0] : ''"/>
                    </div>
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            type="text"
                            ...
                            :error="hasError(`report.${$vnode.key}.view.header`) ? errors[`report.${$vnode.key}.view.header`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`report.${$vnode.key}.view.content`) ? errors[`report.${$vnode.key}.view.content`][0] : ''"/>
                    </div>
                    ...
                    <div class="ap-width-1-1@s ap-width-1-4@m ap-width-1-4@l">
                        <ap-input
                            ...
                            :error="hasError(`report.${$vnode.key}.view.footer`) ? errors[`report.${$vnode.key}.view.footer`][0] : ''"/>
                    </div>
                </ap-grid>
