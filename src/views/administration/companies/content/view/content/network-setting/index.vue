...
export default
{
    ...
    computed:
    {
        ...mapGetters({
            ...
            networkSetting: 'adminCompany/networkSetting',
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await Http.put(
                `/administration/company/${this.$route.params.code}/network/setting`,
                this.form
            );
        ...
        async load()
        {
            const response = await this.loadObject({
                ...
                url: `/administration/company/${this.$route.params.code}/network/setting`
            });
