    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-company-image">Select Photo</label>
                <input class="ap-display-none" id="upload-company-image" type="file" accept="image/**" @change="onFileChange">
                <ap-input
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            const response = await this.update({
                url: `/administration/company/${this.$route.params.code}/logo`,
                form: formPhoto,
            });
