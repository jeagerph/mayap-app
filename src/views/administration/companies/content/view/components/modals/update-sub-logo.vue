<template>
    <ap-modal
        :isOpen.sync="$parent.$data.updateSubLogoModal"
        :isCenter="true">
        <ap-modal-body>
            <ap-modal-title>
                Update Company Sub Logo
            </ap-modal-title>

            <hr class="ap-margin-small-top">

            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-sub-logo-image">Select Photo</label>
                <input class="ap-display-none" id="upload-sub-logo-image" type="file" accept="image/**" @change="onFileChange">
                <ap-input
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            const response = await this.update({
                url: `/administration/company/${this.$route.params.code}/sub-logo`,
                form: formPhoto,
            });
        ...
        closeModal()
        {
            this.$parent.toggleModal('updateSubLogo', false);
        },
