...
export default
{
    ...
    {
        ...mapGetters({
            items: 'adminAccountActivity/items',
            isLoading: 'adminAccountActivity/isLoading',
            page: 'adminAccountActivity/page',
        }),
    ...
    {
        ...mapActions({
            load: 'adminAccountActivity/load',
            loadMore: 'adminAccountActivity/loadMore',
            unset: 'adminAccountActivity/unsetItems',
        }),

        async onLoad()
        {
            const response = await this.load(`/administration/account/${this.$route.params.code}/activities`);
        },
