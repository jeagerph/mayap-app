...
export default
{
    ...
    computed:
    {
        ...mapGetters({
            ...
            template: 'myCompanyIdTemplate/selected',
        }),
    ...
    {
        ...mapActions({
            load: 'myCompanyIdTemplate/load',
            loadMore: 'myCompanyIdTemplate/loadMore',
            unset: 'myCompanyIdTemplate/unsetItems',
        }),
