<template>
    <ap-modal
        :isOpen.sync="$parent.$data.sendBrandingMessageModal"
        :isCenter="true">
                ...
                <ap-grid :gutter="'small'"
                    ...
                    <div class="ap-width-1-1@s ap-width-3-5@m ap-width-3-5@l ap-text-right@m">
                        <p class="ap-text-bold ap-margin-remove">
                            {{ accessUser.company.sms_setting.sender_name }}
                        </p>
                    </div>
                </ap-grid>
...
export default
{
    ...
    computed:
    {
        ...
        {
            return this.$parent.$data.sendBrandingMessageModal;
        },
    },
    ...
    methods:
    {
        ...
        initialize()
        {
            ...
            this.form.message_type = 2;
            this.form.message_sender_name = this.accessUser.company.sms_setting.sender_name;
        },
        ...
        closeModal()
        {
            this.$parent.toggleModal('sendBrandingMessage', false);
        },
    },

    watch:
    {
        sendBrandingMessageModal(val)
        {
            if (val) this.load();
        },
    },
