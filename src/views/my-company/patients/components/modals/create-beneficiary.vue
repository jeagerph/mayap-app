    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await Http.post(
                `/my-company/patient/beneficiary/option`,
                this.form,
            );
            ...
            {
                this.createForm.beneficiaryCode = response.data.slug.code;
                this.$parent.$parent.$data.beneficiary = response.data;
        ...
        async loadProvinces()
        {
            this.loadPrerequisite({
                url: `/my-company/patient/provinces`,
                action: 'provinces'
            });
        ...
        {
            this.loadPrerequisite({
                url: `/my-company/patient/cities?filter[provCode]=${this.form.province_id}`,
                action: 'cities'
            });
        ...
        {
            this.loadPrerequisite({
                url: `/my-company/patient/barangays?filter[cityCode]=${this.form.city_id}`,
                action: 'barangays'
            });
        },
