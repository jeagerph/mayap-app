        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top">
                <p>
                    ...
                    <span class="ap-text-bold">{{template.name}}</span> template.
                </p>
...
export default
{
    ...
    {
        ...mapActions({
            destroy: 'myCompanyDocumentTemplate/destroy',
        }),
        ...
        async submit()
        {
            ...
            const response = await this.destroy({
                url: `/my-company/document-template/${this.template.id}`,
                item: this.template,
            });
            ...
            if (response.status === 200)
            {
                ...
                this.$router.push('/company/document-templates');
            }
