        ...
        <ap-grid>
            <div class="ap-width-1-1@s ap-width-1-3@m ap-width-1-3@l">
                ...
                <div class="ap-margin-small-top">
                    <label for="create-option-with-document-no">
                        <input class="ap-checkbox" id="create-option-with-document-no" type="checkbox"
                            :true-value="1"
                            :false-value="0"
                ...
                <div class="ap-margin-small-top">
                    <label for="create-option-with-qr-code">
                        <input class="ap-checkbox" id="create-option-with-qr-code" type="checkbox"
                            :true-value="1"
                            :false-value="0"
