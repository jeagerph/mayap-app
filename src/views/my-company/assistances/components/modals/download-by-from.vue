<template>
    <ap-modal
        :isOpen.sync="$parent.$data.downloadByFromModal"
        :isCenter="true"
        :size="'container'">

        <ap-modal-body>
            <ap-modal-title>
                Download By Assistance From Report
            </ap-modal-title>
            ...
            <div class="ap-margin-top">
                ...
                <div class="ap-form-stacked">
                    ...
                    <div class="ap-margin-medium-top">
                        <label class="ap-text-bold" for="by-from-include-list">
                            <input type="checkbox"
                                id="by-from-include-list"
                                class="ap-checkbox"
                                :true-value="1"
                                :false-value="0"
...
export default
{
    ...
    computed:
    {
        ...
        downloadByFromModal()
        {
            return this.$parent.$data.downloadByFromModal;
        }
    },
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            let url = `/my-company/assistances/by-from/download?ctx`;
        ...
        closeModal()
        {
            this.$parent.toggleModal('downloadByFrom', false);
        },
    },

    watch:
    {
        downloadByFromModal(val)
        {
            if (val)
            {
                this.loadCities();
