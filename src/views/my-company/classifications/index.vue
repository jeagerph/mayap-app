...
export default
{
    ...
    {
        ...mapGetters({
            items: 'myCompanyClassification/items',
            isLoading: 'myCompanyClassification/isLoading',
            page: 'myCompanyClassification/page',
            selected: 'myCompanyClassification/selected',
        }),
    ...
    {
        ...mapActions({
            load: 'myCompanyClassification/load',
            loadMore: 'myCompanyClassification/loadMore',
            unset: 'myCompanyClassification/unsetItems',
        }),

        async onLoad()
        {
            const response = await this.load(`/my-company/classifications`);
