            ...
            <div class="ap-width-expand">
                <ap-grid :gutter="'small'">
                    ...
                    <div class="ap-width-expand ap-margin-small-left">
                        <h5 class="ap-text-bold" style="font-size: 18px;">
...
import SecondDegreeItemComponent from './second-degree-item';

export default
{
    components:
    {
        SecondDegreeItemComponent,
    },
