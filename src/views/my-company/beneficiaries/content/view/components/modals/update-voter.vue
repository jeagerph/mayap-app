    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top">
                ...
                <div class="ap-margin-top ap-custom-scroll"
                    v-if="!votersLoading">
                    
                    <ul class="ap-list ap-list-divider"
                        v-if="voters.length">
                        <li v-for="(item, index) in voters"
                            :key="index">
                            <ap-grid :gutter="'small'">
                                ...
                                <div class="ap-width-1-1@s ap-width-1-3@m ap-width-1-3@l ap-text-right@m">
                                    <a class="ap-button ap-button-outline-primary ap-button-small ap-button-full-rounded"
                ...
                <form class="ap-form-stacked ap-margin-medium-top"
...
export default
{
    ...
    methods:
    {
        ...
        async loadVoters()
        {
            ...
            const response = await Http.get(`/my-company/beneficiary/${this.beneficiary.slug.code}/voters/check`)
