...
export default
{
    ...
    {
        ...mapGetters({
            items: 'companyBeneficiaryActivity/items',
            isLoading: 'companyBeneficiaryActivity/isLoading',
            page: 'companyBeneficiaryActivity/page',
        }),
    ...
    {
        ...mapActions({
            load: 'companyBeneficiaryActivity/load',
            loadMore: 'companyBeneficiaryActivity/loadMore',
            unset: 'companyBeneficiaryActivity/unsetItems',
        }),

        async onLoad()
        {
            const response = await this.load(`/my-company/beneficiary/${this.$route.params.code}/activities`);
        },
