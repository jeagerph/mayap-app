    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top">
                <p>
                    You are about to delete <span class="ap-text-bold"> {{ patient.full_name }}</span> patient.
                </p>
...
export default
{
    ...
    {
        ...mapActions({
            destroy: 'companyBeneficiaryPatient/destroy',
        }),
        ...
        async submit()
        {
            ...
            const response = await this.destroy({
                url: `/my-company/beneficiary/${this.$route.params.code}/patient/${this.patient.id}`,
                item: this.patient,
            });
