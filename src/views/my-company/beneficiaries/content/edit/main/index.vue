            ...
            <form class="ap-form-stacked ap-margin-top"
                    ...
                    <div class="accordion ap-margin-top" id="form-accordion">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="form-current-address">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-form-current-address" aria-expanded="false" aria-controls="collapse-form-current-address">
                            ...
                            <div id="collapse-form-current-address" class="accordion-collapse collapse show" aria-labelledby="form-current-address" data-bs-parent="#form-accordion" style="">
                                <div class="accordion-body">
                                    ...
                                    <map-component v-if="!isLoading('edit')" />
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse-form-medical-concerns" class="accordion-collapse collapse collapsed" aria-labelledby="form-medical-concerns" data-bs-parent="#form-accordion" style="">
                                <div class="accordion-body">
                ...
                <div class="ap-margin ap-text-right"
                    ...
                    <router-link
                        ...
                        :to="`/company/beneficiaries/${$route.params.code}`">
                        Cancel
                    </router-link>
                    <ap-button
                        type="submit"
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            if(this.changedPhoto)
            {
                ...
                {
                    this.form.photo_for_upload = output;
                });
            }
            
            const response = await this.update({
                url: `/my-company/beneficiary/${this.$route.params.code}`,
                form: this.form,
            });
        ...
        async loadForm()
        {
            const response = await this.edit(`/my-company/beneficiary/${this.$route.params.code}/edit`);
        ...
        async loadQuestionnaires()
        {
            ...
            if (response.status == 200)
            {
                this.questionnaires.forEach(row => {
                    ...
                    let checking = this.form.questionnaires.find(formRow => formRow.question_id == row.id);
