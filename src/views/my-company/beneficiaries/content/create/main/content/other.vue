    ...
    <div class="ap-margin-small-top">
        ...
        <ap-grid :gutter="'small'">
            ...
            <div class="ap-width-1-1@s ap-width-1-2@m ap-width-1-2@l">
                <ap-input
                    ...
                    :error="hasError('civil_status') ? errors.civil_status[0] : ''"/>
        ...
        <ap-grid
            ...
            <div class="ap-width-1-1@s ap-width-1-2@m ap-width-1-2@l">
                ...
                <datalist id="monthlyIncomeOptions">
                    <option value="219,140 above (RICH)" />
                    <option value="131,483 - 219,140 (HIGH INCOME)" />
                    <option value="76,669 - 131,484 (UPPER MIDDLE CLASS)" />
                    <option value="43,828 - 76,669 (MIDDLE CLASS)" />
                    <option value="21,914 - 43,828 (LOW MIDDLE CLASS)" />
                    <option value="10,957 - 21,914 (LOW INCOME)" />
                    <option value="10,957 below (POOR)" />
                </datalist>
            </div>
            <div class="ap-width-1-1@s ap-width-1-2@m ap-width-1-2@l">
                <ap-input
