    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-right-signature-image">Select Photo</label>
...
export default
{
    ...
    methods:
    {
        async upload()
        {
            ...
            {
                this.$parent.$data.form.right_signature = output;
                this.$parent.$data.form.right_signature_for_upload = true;
            });
