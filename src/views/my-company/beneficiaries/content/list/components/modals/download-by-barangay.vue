<template>
    <ap-modal
        :isOpen.sync="$parent.$data.downloadByBarangayModal"
        :isCenter="true"
        :size="'container'">

        <ap-modal-body>
            <ap-modal-title>
                Download Beneficiary By Barangay Report
            </ap-modal-title>
            ...
            <div class="ap-margin-top">
                ...
                <div class="ap-form-stacked">
                    ...
                    <div class="ap-margin-medium-top">
                        <label class="ap-text-bold" for="by-barangay-include-list">
                            <input type="checkbox"
                                id="by-barangay-include-list"
                                class="ap-checkbox"
                                :true-value="1"
                                :false-value="0"
...
export default
{
    ...
    computed:
    {
        ...
        {
            return this.$parent.$data.downloadByBarangayModal;
        }
    },
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            let url = `/my-company/beneficiaries/by-barangay/download?ctx`;
        ...
        closeModal()
        {
            this.$parent.toggleModal('downloadByBarangay', false);
        },
    },

    watch:
    {
        downloadByBarangayModal(val)
        {
