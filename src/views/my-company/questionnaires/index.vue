...
export default
{
    ...
    {
        ...mapGetters({
            items: 'myCompanyQuestionnaire/items',
            isLoading: 'myCompanyQuestionnaire/isLoading',
            page: 'myCompanyQuestionnaire/page',
            selected: 'myCompanyQuestionnaire/selected',
        }),
    ...
    {
        ...mapActions({
            load: 'myCompanyQuestionnaire/load',
            loadMore: 'myCompanyQuestionnaire/loadMore',
            unset: 'myCompanyQuestionnaire/unsetItems',
        }),

        async onLoad()
        {
            const response = await this.load(`/my-company/questionnaires`);
