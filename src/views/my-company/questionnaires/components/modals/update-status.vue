        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top">
                <p>
                    ...
                    <span class="ap-text-bold">{{questionnaire.question}}</span> question.
                </p>
...
export default
{
    ...
    computed:
    {
        ...
        statusName()
        {
            return this.questionnaire.enabled
                ? 'disable'
                : 'enable';
        }
    },
    ...
    methods:
    {
        ...
        async submit()
        {
            ...
            const response = await this.update({
                url: `/my-company/questionnaire/${this.questionnaire.id}/status`,
                form: {},
            });
