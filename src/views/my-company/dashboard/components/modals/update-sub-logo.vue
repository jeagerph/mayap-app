    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-company-sub-logo">Select Photo</label>
                <input class="ap-display-none" id="upload-company-sub-logo" type="file" accept="image/**" @change="onFileChange">
                <ap-input
...
export default
{
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            {
                this.profile.sub_logo = response.data.sub_logo;
