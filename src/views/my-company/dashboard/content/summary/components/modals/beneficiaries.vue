<template>
    <ap-modal
        :isOpen.sync="$parent.$data.beneficiariesModal"
        :isCenter="true">
...
export default
{
    ...
    computed:
    {
        beneficiariesModal()
        {
            return this.$parent.$data.beneficiariesModal;
        },
    },
    ...
    methods:
    {
        async load()
        {
            ...
            const response = await Http.get(
                `/my-company/summary/beneficiaries/total/view?date=${this.form.date}`
            );
        ...
        closeModal()
        {
            this.$parent.toggleModal('beneficiaries', false);
        },
    },

    watch:
    {
        beneficiariesModal(val)
        {
            if (val) this.load();
        },
    }
