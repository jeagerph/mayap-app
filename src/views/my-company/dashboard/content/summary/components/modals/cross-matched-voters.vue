<template>
    <ap-modal
        :isOpen.sync="$parent.$data.crossMatchedVotersModal"
        :isCenter="true">

        <ap-modal-body>
            <ap-modal-title>
                Summary of Crossed Matched Voters
            </ap-modal-title>
...
export default
{
    ...
    computed:
    {
        ...
        {
            return this.$parent.$data.crossMatchedVotersModal;
        },
    },
    ...
    methods:
    {
        async load()
        {
            ...
            const response = await Http.get(
                `/my-company/summary/cross-matched-voters/total/view?date=${this.form.date}`
            );
        ...
        closeModal()
        {
            this.$parent.toggleModal('crossMatchedVoters', false);
        },
    },

    watch:
    {
        crossMatchedVotersModal(val)
        {
            if (val) this.load();
        },
    }
