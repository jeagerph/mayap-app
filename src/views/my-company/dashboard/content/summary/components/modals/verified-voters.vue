<template>
    <ap-modal
        :isOpen.sync="$parent.$data.verifiedVotersModal"
        :isCenter="true">

        <ap-modal-body>
            <ap-modal-title>
                Summary of Verified Voters
            </ap-modal-title>
...
export default
{
    ...
    computed:
    {
        verifiedVotersModal()
        {
            return this.$parent.$data.verifiedVotersModal;
        },
    },
    ...
    methods:
    {
        async load()
        {
            ...
            const response = await Http.get(
                `/my-company/summary/verified-voters/total/view?date=${this.form.date}`
            );
        ...
        closeModal()
        {
            this.$parent.toggleModal('verifiedVoters', false);
        },
    },

    watch:
    {
        verifiedVotersModal(val)
        {
            if (val) this.load();
        },
    }
