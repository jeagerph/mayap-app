<template>
    <ap-modal
        ...
        <ap-modal-body>
            <ap-modal-title>
                Update Officer/Leader Classification
            </ap-modal-title>
...
export default
{
    ...
    {
        ...mapGetters({
            classification: 'myCompanyOfficerClassification/selected',
    ...
    {
        ...mapActions({
            update: 'myCompanyOfficerClassification/update',
        }),
        ...
        async submit()
        {
            ...
            const response = await this.update({
                url: `/my-company/officer-classification/${this.classification.id}`,
                form: this.form,
            });
