    ...
    <ap-modal
        ...
        <ap-modal-body>
            ...
            <div class="ap-margin-top ap-margin-bottom ap-text-center">
                <label class="ap-upload-label-button" for="upload-signature">Select Photo</label>
                <input class="ap-display-none" id="upload-signature" type="file" accept="image/**" @change="onFileChange">
                <ap-input
    ...
    methods:
    {
        ...
        async upload()
        {
            ...
            const response = await this.update({
                url: `/my-company/assignatory/${this.assignatory.id}/signature`,
                form: formPhoto,
            });
