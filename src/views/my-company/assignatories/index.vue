...
export default
{
    ...
    {
        ...mapGetters({
            items: 'myCompanyAssignatory/items',
            isLoading: 'myCompanyAssignatory/isLoading',
            page: 'myCompanyAssignatory/page',
            selected: 'myCompanyAssignatory/selected',
        }),
    ...
    methods:
    {
        ...mapActions({
            ...
            loadMore: 'myCompanyAssignatory/loadMore',
            unset: 'myCompanyAssignatory/unsetItems',
        }),

        async onLoad()
        {
            const response = await this.load(`/my-company/assignatories`);
